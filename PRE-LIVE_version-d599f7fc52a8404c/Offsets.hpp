...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-d599f7fc52a8404c";
    ...
    namespace Animator {
         inline constexpr uintptr_t ActiveAnimations = 0x620;
    }
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7f6c228;
    ...
    namespace GuiObject {
         ...
         inline constexpr uintptr_t Image = 0x9c8;
         inline constexpr uintptr_t LayoutOrder = 0x578;
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t HumanoidRootPart = 0x4b8;
         inline constexpr uintptr_t HumanoidState = 0x8d0;
         inline constexpr uintptr_t HumanoidStateID = 0x20;
         inline constexpr uintptr_t IsWalking = 0x94e;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x7fea7d0;
    }
    ...
    namespace Player {
         ...
         inline constexpr uintptr_t Mouse = 0xda8;
    ...
    namespace PlayerConfigurer {
         inline constexpr uintptr_t Pointer = 0x7f49720;
    }

    namespace PlayerMouse {
         inline constexpr uintptr_t Icon = 0x0;
         inline constexpr uintptr_t Workspace = 0x118;
    }
    ...
    namespace Primitive {
         ...
         inline constexpr uintptr_t Material = 0x248;
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x801d408;
    }
    ...
    namespace Tool {
         ...
         inline constexpr uintptr_t Enabled = 0x3eb;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t FakeDataModel = 0xa50;
         inline constexpr uintptr_t Pointer = 0x7b1f068;
