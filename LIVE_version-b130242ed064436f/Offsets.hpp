...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-b130242ed064436f";
    ...
    namespace AnimationTrack {
         ...
         inline constexpr uintptr_t IsPlaying = 0x9d8;
         inline constexpr uintptr_t Looped = 0xf5;
         inline constexpr uintptr_t Speed = 0xe4;
    }

    namespace Animator {
         inline constexpr uintptr_t ActiveAnimations = 0x858;
    }
    ...
    namespace BasePart {
         ...
         inline constexpr uintptr_t Color3 = 0xd1;
    ...
    namespace GuiObject {
         ...
         inline constexpr uintptr_t Image = 0x9f8;
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t TargetPoint = 0x3;
    ...
    namespace Instance {
         ...
         inline constexpr uintptr_t ClassBase = 0xdd8;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t MousePosition = 0x3;
         inline constexpr uintptr_t SensitivityPointer = 0x8243900;
    }
    ...
    namespace PlayerConfigurer {
         inline constexpr uintptr_t Pointer = 0x819ff40;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x82766c8;
    }
